...
async function generateCampaignSemanticQueries(productDescription: string) {
  const response = await generateStructuredOutput({
    ...
    systemPrompt: [
      ...
      "",
      "Your goal is to find posts and comments from people who may hire outside help, outsource work, or actively need a service provider.",
      "",
      "Return only JSON matching the schema.",
    ].join("\n"),
    temperature: 0.7,
    userPrompt: [
      "Generate 18 semantic search queries representing high-intent service-buying signals in online communities such as Reddit.",
      "",
      "The goal is to detect users who are likely to buy a service, hire help, outsource work, or actively look for someone to solve a painful problem for them.",
      "",
      ...
      "- is asking for recommendations for service providers or implementation help",
      "- is struggling with a workflow that could realistically lead to hiring outside help",
      "",
      ...
      "- discussing tools in general without clear need for help",
      "- talking about a solved problem",
      "- asking for a full-time hire or job search help unless clearly relevant to outsourced service work",
      "",
      "Queries should resemble natural Reddit posts",
      "or comments.",
      "",
      "The wording should sound like real people describing pain, asking for help, considering outsourcing, or looking for expert support.",
      "",
      ...
      "",
      "Avoid generic broad phrases like:",
      "- growth",
      "- scale faster",
      "- improve workflow",
      "- automate business",
      ...
      "}",
      "",
      "Use short category labels such as:",
      "- help_request",
      "- outsourcing_intent",
      "- workflow_pain",
      "- implementation_need",
