...
import { CalendarDays, Database, FlaskConical, ScrollText, Search, UserPlus } from "lucide-react";
          ...
          <div className="grid gap-4 rounded-[20px] bg-[#121212] p-4 shadow-[rgb(18,18,18)_0px_1px_0px,rgb(124,124,124)_0px_0px_0px_1px_inset] lg:grid-cols-[1.1fr_1.2fr_0.9fr] lg:items-start">
            <div className="grid gap-3">
              ...
              <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                ...
                <AdminReportLink href="/admin/analytics/semantic-queries" icon={<Search className="h-4 w-4" />} label="Semantic Queries" />
