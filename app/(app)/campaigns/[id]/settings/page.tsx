...
export default async function CampaignSettingsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (resolveViewerAppMode(config.appMode, isAdminAccount) !== "LIVE") redirect(`/campaigns/${id}`);
