...
import { SEMANTIC_SCAN_SCHEDULE_LABEL } from "@/lib/daily-semantic-schedule";
  ...
  return (
    <section className="space-y-5">
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard label={`Next scan · ${SEMANTIC_SCAN_SCHEDULE_LABEL}`} value={summaryMetrics.nextSync} />
