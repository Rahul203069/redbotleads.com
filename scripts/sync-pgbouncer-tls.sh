...
# Docker must be able to traverse the directory while creating build contexts.
# The private key remains protected separately with mode 640.
install -d -m 755 -o root -g "$PGBOUNCER_GID" "$TARGET_DIR"
